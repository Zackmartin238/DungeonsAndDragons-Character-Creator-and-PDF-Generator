...
def chooseDEX(currentframe):
        ...
        var5 = IntVar()
        msg = Message( refreshedFRAME, text = "Let's Roll Some Dice!")
        msg.pack()
        main_msg1= Message(refreshedFRAME, text="Alright, you rolled!")
        main_msg1.pack()
        main_msg1= Message(refreshedFRAME, text="Now choose Your DEX modifier")
        main_msg1.pack()
        ...
        Button(refreshedFRAME, text="Submit", command= lambda: submit_DEX_decision(var5.get())).pack()
...
def chooseCON():
        ...
        main_msg1= Message(refreshedFRAME, text="Alright, you rolled!")
        main_msg1.pack()
        main_msg1= Message(refreshedFRAME, text="Now choose Your CON modifier")
        main_msg1.pack()
        Radiobutton(refreshedFRAME, text= dice_1, variable=var5,command= setdecision1(1), value=1).pack(side="left")
        Radiobutton(refreshedFRAME, text= dice_2, variable=var5,command= setdecision2(2), value=2).pack(side="left")
        Radiobutton(refreshedFRAME, text= dice_3, variable=var5,command= setdecision3(3), value=3).pack(side="left")
        Radiobutton(refreshedFRAME, text= dice_4, variable=var5,command= setdecision4(4), value=4).pack(side="left")
        Button(refreshedFRAME, text="Submit", command= lambda: submit_CON_decision(var5.get())).pack()
        return var5, decision
def chooseINT():
        global refreshedFRAME
        refreshedFRAME.destroy()
        ...
        main_msg1= Message(refreshedFRAME, text="Alright, you rolled!")
        main_msg1.pack()
        main_msg1= Message(refreshedFRAME, text="Now choose Your INT modifier")
        main_msg1.pack()
        Radiobutton(refreshedFRAME, text= dice_1, variable=var5,command= setdecision1(1), value=1).pack(side="left")
        Radiobutton(refreshedFRAME, text= dice_2, variable=var5,command= setdecision2(2), value=2).pack(side="left")
        Radiobutton(refreshedFRAME, text= dice_3, variable=var5,command= setdecision3(3), value=3).pack(side="left")
        Button(refreshedFRAME, text="Submit", command= lambda: submit_INT_decision(var5.get())).pack()
...
def chooseWIS():
        ...
        main_msg1= Message(refreshedFRAME, text="Alright, you rolled!")
        main_msg1.pack()
        main_msg1= Message(refreshedFRAME, text="Now choose Your WIS modifier")
        main_msg1.pack()
        Radiobutton(refreshedFRAME, text= dice_1, variable=var5,command= setdecision1(1), value=1).pack(side="left")    
        Radiobutton(refreshedFRAME, text= dice_2, variable=var5,command= setdecision2(2), value=2).pack(side="left")
        Button(refreshedFRAME, text="Submit", command= lambda: submit_WIS_decision(var5.get())).pack()
        return number_of_choices, var4
def chooseCHA():
        global number_of_choices
        global refreshedFRAME
        ...
        main_msg1= Message(refreshedFRAME, text="Alright, you rolled!")
        main_msg1.pack()
        main_msg1= Message(refreshedFRAME, text="Now choose Your CHA modifier")
        main_msg1.pack()
        Radiobutton(refreshedFRAME, text= dice_1, variable=var5,command= setdecision1(1), value=1).pack(side="left")
        
        Button(refreshedFRAME, text="Submit", command= lambda: submit_CHA_decision(var5.get())).pack()
        return number_of_choices, var4
...
Radiobutton(frame3, text='Dragonborn - +2 STR +1 CON', variable=var2, value=1,command=selection()).pack()

Radiobutton(frame3, text='Dwarf - +2 CON and subrace', variable=var2, value=2,command=selection()).pack()

Radiobutton(frame3, text='Elf - +2 DEX and subrace', variable=var2, value=3,command=selection()).pack(anchor=W)

Radiobutton(frame3, text='Half-Elf - +2 CHA', variable=var2, value=4,command=selection()).pack()

Radiobutton(frame3, text='Halfling - +2 DEX', variable=var2, value=5,command=selection()).pack()

Radiobutton(frame3, text='Half-Orc - +2 STR +1 CON', variable=var2, value=6,command=selection()).pack()

Radiobutton(frame3, text='Human +1 TO ALL', variable=var2, value=7,command=selection()).pack()

Radiobutton(frame3, text='Gnome +2 INT', variable=var2, value=8,command=selection()).pack(anchor=W)

Radiobutton(frame3, text='Tiefling +1 INT +2 CHA', variable=var2, value=9,command=selection()).pack(anchor=W)

sp = Spinbox(frame4, from_= 1, to = 20, text="level", textvariable=level)
sp.pack()

Button(frame1, text="Submit", command=lambda : submit(), padx=50, pady=5).grid(row=8, columnspan=8, pady=5)
...
def startassignSTR():
        ...
        main_msg1= Message(frameDICE, text="Alright, you rolled!")
        main_msg1.pack()

        main_msg1= Message(frameDICE, text="Now choose one to be your Strength variable")
        main_msg1.pack()
        ...
        Button(frameDICE, text="Submit", command= lambda: submit_STR_decision(decision)).pack()
...
def create_dnd_character(yourclass, yourrace, level=int()): 
    ...
    if yourrace == "dwarf":
        ...
        Button(newframe, text="Submit", command= lambda : variant(), padx=50, pady=5).pack(anchor=W)
    if yourrace == "elf":
        global race_DEX_bonus
        race_DEX_bonus = 2
        race = "Elf"
        ...
        def variant():
            ...
            if varchoice == 1:
                ...
                newframe.destroy()
                startassignSTR()
                print(race,currentvariant, level)
    ...
    if yourrace == "gnome": 
        race_INT_bonus = 2 
        startassignSTR()
    # need to get half elf to have +1 to 2 other chosen stats
